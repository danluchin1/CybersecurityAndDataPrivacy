...
| :---         |     :---:      |     :---:      |     :---:      |
| 07.01.2026 | 1.5 | Kick-off lecture | Participated in the meeting |
| 15.01.2026 | 1.5 | Intro to PortSwigger | Participated in the meeting  |
...
| 29.01.2026 | 2 | Introduction to PortSwigger | I have completed the other 3 labs which were 1 lab from the Authentication topic and two from the Access Control topic. |
...
| 08.02.2026 | 1 | The Booking system project → Phase 1 → Part 2 | I have downloaded the docker compose file for Phase 1/ Part 2 web app. Run the Automated ZAP Penetration Test and generated the Zap Report Round 2 file. |
...
| 13.02.2026 | 1 | The Booking system project → Phase 2 | I have made manual/automated penetration tests with ZAP to the updated version of the app. Added the markdown file to the repo. |
