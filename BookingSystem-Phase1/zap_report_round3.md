...
| --- | --- | --- | --- | --- |
| Medium | Exceeded Low |  | Percentage of memory used | 89    |
...
| Info | Informational | http://localhost:8003 | Percentage of responses with status code 2xx | 50 % |
| Info | Informational | http://localhost:8003 | Percentage of responses with status code 3xx | 39 % |
| Info | Exceeded Low | http://localhost:8003 | Percentage of responses with status code 4xx | 9 % |
